package io.buo.api.client.constant;
...
public class BHexConstants {
    ...
    public static final String API_BASE_URL = "https://api.bhuo.io/";

    /**
     * Streaming API base URL.
     */
    public static final String WS_API_BASE_URL = "wss://api.bhuo.io/openapi/quote/ws/v1";

    public static final String WS_API_USER_URL = "wss://api.bhuo.io/openapi/ws/";
